    ...
    <div class="profile-wrapper">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="todayTab">
            ...
            <?php } }else{ ?>
                <tr><td colspan="3" class="text-danger text-center">No Visit Done Today.</td></tr>
           <?php } ?>
              </tbody>
            </table>
          </div>
          ...
          <div class="tab-pane fade show active" id="allTab">
            ...
            <?php } }else{ ?>
                <tr><td colspan="3" class="text-danger text-center">No Visit Done.</td></tr>
            <?php } ?>
              </tbody>
            </table>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p><strong>Discussion Pointer:</strong> <span id="discussion_pointer"></span></p>
...
<script>
function openDetail(profile_id, profile_type, name,mobile,address,discussion_pointer){
...
//   document.getElementById('m_type').innerText = type;
   document.getElementById('discussion_pointer').innerText = discussion_pointer;
}
</script>
...
function filterByDate() {
    ...
    if (from && to) {
        window.location.href =
          "<?= base_url('visit-created') ?>?from=" + from + "&to=" + to;
    }
}
