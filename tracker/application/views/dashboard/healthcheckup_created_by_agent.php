        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="todayTab">
            ...
            <?php 
                ...
                $today_profiles = getTodayProfiles('tracker_patient', $login_id, 'Healthcheckup');
            ...
            <?php } }else{ ?>
                <tr><td colspan="3" class="text-danger text-center">No Health Checkup Done today</td></tr>
           <?php } ?>
              </tbody>
            </table>
          </div>
          ...
          <div class="tab-pane fade show active" id="allTab">
           ...
           <div class="date-range">
            ...
            <?php } }else{ ?>
                <tr><td colspan="3" class="text-danger text-center">No Health Checkup Done.</td></tr> 
            <?php } ?>
              </tbody>
            </table>
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-header">
                <h5 class="modal-title">Healthcare Details</h5>
...
function filterByDate() {
    ...
    if (from && to) {
        window.location.href =
          "<?= base_url('healthcheckup-created') ?>?from=" + from + "&to=" + to; 
    }
}
