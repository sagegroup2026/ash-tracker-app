        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="todayTab">
            ...
            <?php 
                ...
                $today_profiles = getTodayProfiles('tracker_operation', $login_id);
            ...
            ?>
             <tr data-search="<?= strtolower( $row->name.' '.$row->contact.' '.$row->profile_id) ?>" >
                 <td><?php echo $x++;?></td>
                   <td>
                    <span><strong>Type:</strong> <?= ucfirst($row->operation_type ?? '-') ?></span><br>
                    <span><strong>Date:</strong> 
                        <?= !empty($row->operation_date) ? date('d-m-Y', strtotime($row->operation_date)) : '-' ?>
                    </span><br>
                   </td>
            ...
            <?php } }else{ ?>
                <tr><td colspan="3" class="text-danger text-center">No Agreement preparation Created today.</td></tr> 
           <?php } ?>
              </tbody>
            </table>
          </div>
          ...
          <div class="tab-pane fade show active" id="allTab">
            ...
            <?php } }else{ ?>
               <tr><td colspan="3" class="text-danger text-center">No Agreement preparation Created.</td></tr>
            <?php } ?>
              </tbody>
            </table>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title">Agreement preparation Details</h5>
...
<script>
function openDetail(type, date, from, to){
...
function filterByDate() {
    ...
    if (from && to) {
        window.location.href =
          "<?= base_url('agreement-preparation-created') ?>?from=" + from + "&to=" + to;  
    }
}
